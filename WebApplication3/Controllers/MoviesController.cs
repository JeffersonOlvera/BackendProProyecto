...
namespace WebApplication3.Controllers
{
    public class MoviesController : Controller
    {
        ...
        // GET: Movies
        public async Task<IActionResult> Index(int? genreId, int? directorId)
        {
        ...
        public async Task<IActionResult> Create([Bind("Id,Title,Synopsis,Duration,ReleaseDate,Image,GenreId,DirectorId")] Movie movie)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id,Title,Synopsis,Duration,ReleaseDate,Image,GenreId,DirectorId")] Movie movie)
        {
            if (id != movie.Id)
            {
                return NotFound();
